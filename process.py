...
article_vec_raw = {}
stem_map = {}
for art in top_topics:
	for id,body in id_article_map[art].items():
		# write .class
		classification_f.write(id + ',' + art + "\n")
		...
		new_body = "".join([ c.lower() if c.isalnum() else " " for c in body ])
		...
		# Eliminate any tokens from the stop list that is provided
